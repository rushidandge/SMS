...
<head>
    ...
    <link
        href="{{ asset('asssets/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/OwlCarousel2-2.2.1/owl.carousel.css')}}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('asssets/plugins/OwlCarousel2-2.2.1/owl.theme.default.css')}}">
                                        ...
                                        <div>
                                            <a href="#">
                                                <div
                                                    ...
                                                    <div class="logo_content">
                                                        <div class="logo_text logo_text_not_ie">Sports Events Management
                                                        </div>
                                                        <div class="logo_sub">All Tournament , Competition , Events At
                                                            One Place</div>
                                                    </div>
                                                </div>
                                            </a>
                            ...
                            <div class="search_container">
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            <div
                                                class="search_content d-flex flex-row align-items-center justify-content-end">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="home_content">
                                <!-- <div class="home_date">January 28, 2020</div>
                                <div class="home_title">All Muet Futsal Tournament</div> -->
                                <!-- <div class="home_location">In Collaboration With ..... </div> -->
                                <br><br><br><br>
