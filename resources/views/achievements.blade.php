        ...
        <div class="menu trans_500">
            <div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
                ...
                <ul>
                    ...
                    <li class="menu_item"><a href="/facilities">Facilities</a></li>
                    <li class="menu_item"><a href="/contact">Contact Us</a></li>
                    
                    <li class="menu_item"><a href="/achievements">Achievements</a></li>
                                        ...
                                        <div>
                                            <a href="#">
                                                <div class="logo_container d-flex flex-row align-items-start justify-content-start">
                                                    ...
                                                    <div class="logo_content">
                                                        <div id="logo_text" class="logo_text logo_text_not_ie"> Sports Management System</div>
                                                        <div class="logo_sub">University Of Engineering And Technology</div>
                                                    </div>
                                                </div>
                                            </a>
                                            ...
                                            <div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
                                                <nav class="main_nav">
                                                    <ul>
                                                        ...
                                                        <li class="active"><a href="/achievements">Achievements</a></li>
